...
export default function HomePage() {
  ...
  const jsonLd = {
    ...
    "description": "CapyClass is the interactive coding classroom platform where teachers create classrooms, assign coding tasks, and students write, run, and review code in real time.",
